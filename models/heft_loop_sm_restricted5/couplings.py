...
GC_TTHHH_MHEFT = Coupling(name = 'GC_TTHHH_MHEFT',
                  value = '-3*CT3*(complex(0,1)*yt)/(v**2*cmath.sqrt(2))',
                  order = {'MHEFT':1,'QED':0})

GC_TTHH_MHEFT = Coupling(name = 'GC_TTHH_MHEFT',
                   value = '-2*CT2*(complex(0,1)*yt)/(v*cmath.sqrt(2))',
                   order = {'MHEFT':1,'QED':0})
...
#######################################
# Higgs self-interaction modifications
#######################################
