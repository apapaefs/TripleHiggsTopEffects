...
##################################
# top-Higgs contact interactions
##################################

V_TTHHH_MHEFT = Vertex(name = 'V_TTHHH_MHEFT',
               particles = [ P.t__tilde__, P.t, P.H, P.H, P.H ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFSSS6 ],
               couplings = {(0,0):C.GC_TTHHH_MHEFT})

V_TTHH_MHEFT = Vertex(name = 'V_TTHH_MHEFT',
               particles = [ P.t__tilde__, P.t, P.H, P.H ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFSS26 ],
               couplings = {(0,0):C.GC_TTHH_MHEFT})

V_TTH_MHEFT = Vertex(name = 'V_TTH_MHEFT',
               particles = [ P.t__tilde__, P.t, P.H ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFS1 ],
               couplings = {(0,0):C.GC_TTH_MHEFT})


#################################################################
# MHEFT contact interaction modification to the Higgs self-coupling
#################################################################
 
V_HHH_MHEFT = Vertex(name = 'V_HHH_MHEFT',
             particles = [ P.H, P.H, P.H ],
             color = [ '1' ],
             lorentz = [ L.SSS1 ],
             couplings = {(0,0):C.GC_HHH_MHEFT})

V_HHHH_MHEFT = Vertex(name = 'V_HHHH_MHEFT',
             particles = [ P.H, P.H, P.H, P.H ],
             color = [ '1' ],
             lorentz = [ L.SSSS1 ],
             couplings = {(0,0):C.GC_HHHH_MHEFT})
