...
##########################################################
# R2 for the Higgs interaction contributions from the MHEFT
##########################################################
...
V_GGH = CTVertex(name = 'V_GGH',
              ...
              couplings = {(0,0,0):C.R2_GGHc,(0,0,1):C.R2_GGHb,(0,0,2):[C.R2_GGH_C1, C.R2_GGHt]},
              type = 'R2')

##########################################################
# R2 VERTEX FROM SMMHEFTATNLO for GG -> HH
# includes CT2 and CT1 single insertions in R2GC_1297_467,
# the SM in R2_GGHHt
# and CT1 double insertion in R2_GGHHtDouble
###########################################################
...
V_GGHH = CTVertex(name = 'V_GGHH',
                ...
                lorentz = [ L.R2_GGHH ],
                loop_particles = [[[P.c]],[[P.b]],[[P.t]]],
                couplings = {(0,0,0):C.R2_GGHHc,(0,0,1):C.R2_GGHHb,(0,0,2):[ C.R2GC_1297_467, C.R2_GGHHt, C.R2_GGHH_DoubleC1 ]},
                type = 'R2')
