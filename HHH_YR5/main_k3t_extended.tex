...
\end{center}
\vspace{-4mm}
\caption{\label{fig:ct3benchmarks}Normalised $m_{3h}$ and $\sum p_{T,h}$ distributions at the HL-LHC for the SM and the two rate-matched benchmarks $(\kappa_3,\kappa_4,\kappa_{3t})=(2.10,17,-0.20)$ and $(1.9,0,0.40)$. We fix $\kappa_t=1$ and $\kappa_{2t}=0$.}
\end{figure}

The two mixed-coupling benchmarks in~Figure~\ref{fig:ct3benchmarks} provide more dramatic examples. Although their inclusive cross sections remain close to the SM prediction, both produce large distortions of the normalised distributions. The samples use the same PDFs and scale choice as the inclusive-rate parametrisation.
