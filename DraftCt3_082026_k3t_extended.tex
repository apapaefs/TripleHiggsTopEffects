...
\begin{figure}[t!]
\begin{center}
\includegraphics[width=0.45\textwidth]{artifacts/figures/14tev-ct3-mu65-benchmarks-m3h.pdf} \quad
\includegraphics[width=0.45\textwidth]{artifacts/figures/14tev-ct3-mu65-benchmarks-sum-pth.pdf}
\end{center}
\vspace{-4mm}
\caption{\label{fig:ct3benchmarks}Normalised $m_{3h}$ and $\sum p_{T,h}$ distributions at the HL-LHC for the SM and the two $\mu_{3h}\simeq65$ benchmarks $(\kappa_3,\kappa_4,\kappa_{3t})=(2.1,23,-2.3)$ and $(2.2,0,2.2)$. The distributions use the same $40\,\mathrm{GeV}$ binning and displayed ranges as Figures~\ref{fig:distributions} and~\ref{fig:distributions2}. We fix $\kappa_t=1$ and $\kappa_{2t}=0$.}
\end{figure}

The two mixed-coupling benchmarks in~Figure~\ref{fig:ct3benchmarks} provide more dramatic examples at an enhanced but nearly degenerate inclusive rate. Both have $\mu_{3h}\simeq65$, yet produce large distortions of the normalised distributions relative to the SM, including a pronounced migration towards larger invariant masses and transverse momenta. The samples use the same PDFs and scale choice as the inclusive-rate parametrisation.
